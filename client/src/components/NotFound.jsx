...
const NotFound = () => {
  return (
    <div className='flex flex-col items-center gap-1 p-10  justify-center min-h-screen'>
        ...
        <h2 className='text-md sm:text-lg md:text-xl font-bold'>Page Not Found</h2>
        
        <p className='text-[10px] text-gray-600 text-center'>Sorry, but we can't find the page you are <br/>looking for...</p>
