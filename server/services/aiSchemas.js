...
//Defines the schema for creating a project from scratch.
export const GenerationResultSchema=z.object({
    files:z.record(z.string(), z.string()),  //"files": {"src/App.jsx": "export default function App() { ... }",   }
    description:z.string().default('Generated project')
})

//Defines an individual file modification operation (useful for editing existing code).
